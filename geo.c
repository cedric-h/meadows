...
void geo_cave(Geo *geo) {
  ...
  float cave_ground_z = -0.10000000149011612;
  Vec2 cave_ground_vpos[] = {
    ...
    { 0.6382354497909546, -0.08982373028993607 },
    { -0.3988587260246277, -0.42375531792640686 },
    { -0.584080696105957, -0.7941993474960327 },
    { -0.4618341624736786, -1.0127613544464111 },
    { -0.38774535059928894, -1.2683677673339844 },
    { 1.0508403778076172, 0.03929976373910904 },
    { 1.7991372346878052, -0.045902352780103683 },
    { 1.828772783279419, -0.18296663463115692 },
    { 2.2436702251434326, -0.2570554316043854 },
  };
  ...
  Vec2 cave_roof_vpos[] = {
    ...
    { -1.281934142112732, -0.10490782558917999 },
    { -1.2633637189865112, -0.34697195887565613 },
    { -0.8288845419883728, -0.43190857768058777 },
    { 1.2797949314117432, 1.276375651359558 },
    { 0.7428160905838013, 1.4079623222351074 },
    { 0.3048793375492096, 1.424938678741455 },
    ...
    { -1.7564350366592407, 0.7787490487098694 },
    { 1.7780400514602661, 0.9503978490829468 },
    { 1.700602650642395, 0.915356457233429 },
    ...
    { 0.2509584426879883, 0.7226558327674866 },
    ...
    { -0.6040006875991821, 0.03802713379263878 },
    { -0.7224363088607788, -0.1659243404865265 },
  };
  ...
  float cave_door_side_z = 0.01631774939596653;
  ...
  float cave_right_side_z = -0.002846762537956238;
  Vec2 cave_right_side_vpos[] = {
    ...
    { 2.3976082801818848, -0.1418178677558899 },
  };
  ...
  ExportedGeo exported_geos[] = {
    {  cave_ground_idx,  ARR_LEN(cave_ground_idx), cave_ground_z, cave_ground_vpos, },
    {  cave_roof_idx,  ARR_LEN(cave_roof_idx), cave_roof_z, cave_roof_vpos, },
    {  cave_side_idx,  ARR_LEN(cave_side_idx), cave_side_z, cave_side_vpos, },
    {  cave_door_side_idx,  ARR_LEN(cave_door_side_idx), cave_door_side_z, cave_door_side_vpos, },
    {  cave_door_idx,  ARR_LEN(cave_door_idx), cave_door_z, cave_door_vpos, },
    {  cave_right_side_idx,  ARR_LEN(cave_right_side_idx), cave_right_side_z, cave_right_side_vpos, },
  };
  ...
  for (int i = 0; i < ARR_LEN(exported_geos); i++) {
    ...
    geo_geo(geo, eg->vpos, eg->idx, eg->idx_len, eg->z, (Vec2){0}, c, 1.0f);
  }
}
